...
|Resurrection|Ally|1 AP, 15 MP|The Savior immediately restores a downed enemy to half its maximum HP, rounded down.  This enemy will then gain the Puppet status effect, and will fight on the Savior's side until the status effect is removed.
